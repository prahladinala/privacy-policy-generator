const websiteName = document.getElementById('input_name')
const websiteURL = document.getElementById('input_url')
const generateBtn = document.getElementById('generate_btn')
const outputContent = document.getElementById('output_content')
const showView = document.getElementById('output_view')
...
function generator() {
    ...
    if (Name == "" || Url == "") {
        ...
        // console.log(`${Name} and ${Url}`)
        var content = `<h1>Privacy Policy for ${Name}</h1>
...
<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in ${Name}. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the 
<a href="https://prahladinala.com/tool/privacy-policy-generator/index.html">Prahlad Inala Privacy Policy Generator</a>.</p>
